    ...
    <div class="row row-md">
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				<div class="t-icon right"><span class="bg-warning"></span><i class="ti-archive"></i></div>
				<div class="t-content">
					<h6 class="text-uppercase mb-1">To. of Drivers</h6>
					<h1 class="mb-1">{{$provider_approval}}</h1>
					<i class="fa fa-caret-down text-danger mr-0-5"></i><span>waiting for Approval</span>
				</div>
			</div>
		</div>
		<!--<div class="col-lg-3 col-md-6 col-xs-12">
