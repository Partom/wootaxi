		...
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-view-grid"></i></span>
					<span class="s-text">Custom Notify</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.user.push') }}">Custom Notify</a></li>
				</ul>
			</li>
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-view-grid"></i></span>
					<span class="s-text">One Way Location</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.location.index') }}">List One Way Location</a></li>
					<li><a href="{{ route('admin.location.create') }}">Add One Way Location</a></li>
				</ul>
			</li>
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-layout-tab"></i></span>
					<span class="s-text">Cars Model</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.car.index') }}">List Cars</a></li>
					<li><a href="{{ route('admin.car.create') }}">Add New Car</a></li>
				</ul>
			</li>
