    	...
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{ route('admin.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('site_title', 'WooCabs')  }}" name="site_title" required id="site_title" placeholder="Site Name">
					</div>
				</div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ Setting::get('site_copyright', '&copy; '.date('Y').' Hepto') }}" name="site_copyright" id="site_copyright" placeholder="Site Copyright">
                    </div>
                </div>
