            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">{{ $request->user?$request->user->first_name:'' }} {{ $request->user?$request->user->last_name:'' }}</dd>

                        <dt class="col-sm-4">Provider Name :</dt>
                        @if($request->provider)
                        <dd class="col-sm-8">{{ $request->user?$request->provider->first_name:'' }} {{ $request->user?$request->provider->last_name:'' }}</dd>
                        @else
                        ...
                        @elseif($request->ride_way == 'ROUND')
                        <dt class="col-sm-4">Ride Start Time :</dt>
                        <dd class="col-sm-8">
                            @if($request->user_started_at != "0000-00-00 00:00:00")
                                {{ date('jS \of F Y h:i:s A', strtotime($request->user_started_at)) }} 
                            @else
                                - 
                            @endif
                         </dd>
                        ...
                        <dd class="col-sm-8">
                            @if($request->user_finished_at != "0000-00-00 00:00:00") 
                                {{ date('jS \of F Y h:i:s A', strtotime($request->user_finished_at)) }}
                            @else
                                - 
                            @endif
                        </dd>
                        ...
                        @if($request->payment)
                        <dt class="col-sm-4">Base Fare :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->fixed) }}</dd>

                        <dt class="col-sm-4">Distance Fare :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->distance) }}</dd>

                        <dt class="col-sm-4">Traffic Fare :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->minutes) }}</dd>

                        <dt class="col-sm-4">Connection Fees :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->connection) }}</dd>

                        <dt class="col-sm-4">Day Fees :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->day) }}</dd>
                        
                        <dt class="col-sm-4">Total Amount :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->total) }}</dd>
                        
                        <dt class="col-sm-4">Tax Fare :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->tax) }}</dd>
                        
                        <dt class="col-sm-4">Discount Deduction :</dt>
                        ...
                        <dt class="col-sm-4">Payable Amount :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->paid) }}</dd>
                        ...
                        <dt class="col-sm-4">Ride In : </dt>
                        <dd class="col-sm-8">
                            {{ $request->ride_in}} CITY
                        </dd>
                        <dt class="col-sm-4">Ride Way : </dt>
                        <dd class="col-sm-8">
                            {{ $request->ride_way}} TRIP
                        </dd>
