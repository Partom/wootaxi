    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.service.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    <label for="fixed" class="col-xs-2 col-form-label">Connection Fees ({{ currency('') }})</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->connection }}" name="connection" required id="connection" placeholder="Connection Fees">
                    </div>
                </div>
                <div class="form-group row">
