    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.service.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    <label for="fixed" class="col-xs-12 col-form-label">Inter Base Price ({{ currency() }})</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('fixed') }}" name="fixed" required id="fixed" placeholder=" Inter Base Price">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="outer_fixed" class="col-xs-12 col-form-label">Outer Base Price ({{ currency('') }})</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('outer_fixed')}}" name="outer_fixed" required id="outer_fixed" placeholder="Outer Base Price">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="fixed" class="col-xs-12 col-form-label">Connection Fees ({{ currency() }})</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('connection') }}" name="connection" required id="connection" placeholder="Connection Fees">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="day" class="col-xs-12 col-form-label">Day Fees</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('day') }}" name="day" required id="day" placeholder="Day Fees">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="distance" class="col-xs-12 col-form-label">Inter Base Distance ({{ distance() }})</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('distance') }}" name="distance" required id="distance" placeholder="Inter Base Distance">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="outer_distance" class="col-xs-12 col-form-label">Outer Base Distance ({{ distance() }})</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('outer_distance')}}" name="outer_distance" required id="outer_distance" placeholder="Outer Base Distance">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="price" class="col-xs-12 col-form-label">Inter Distance Price ({{ currency() }})</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('price') }}" name="price" required id="price" placeholder="Inter Distance Price">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="outer_price" class="col-xs-12 col-form-label">Outer Distance Price ({{ currency() }})</label>
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ old('outer_price')}}" name="outer_price" required id="outer_price" placeholder="Outer Distance Price">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="ride" class="col-xs-12 col-form-label">Applicable Ride</label>
                    <div class="col-xs-10">
                        <select class="form-control" id="ride" name="ride">
                            <option value="INTER">INTER CITY</option>
                            <option value="OUTER">OUTER CITY</option>
