                                ...
                                <div class="row no-margin">
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group no-margin">
                                            ...
                                            <input type="text" class="form-control" placeholder="Car Color" name="service_color" value="{{ Auth::guard('provider')->user()->service? Auth::guard('provider')->user()->service->service_color : "" }}">
                                        </div>
                                    </div>
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-right-padding">
                                        <div class="form-group">
                                            <label>Accessories Type</label>
                                             <select class="form-control" name="property" id="property">
                                                ...
                                                <option value="own" {{ Auth::guard('provider')->user()->service?Auth::guard('provider')->user()->service->property== 'own'?'selected':'':''}} >Own Board</option>
                                                <option value="rental" {{ Auth::guard('provider')->user()->service?Auth::guard('provider')->user()->service->property== 'rental'?'selected':'':''}} >Rental Board</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
