...
<head>
    <meta charset="utf-8">
    <title>A simple, clean, and responsive HTML Booking Receipt template</title>
...
<body>
    <div class="invoice-box">
        <hr>
        <h3 align="center" font-weight="bold">Woocabs Booking Receipts</h3>
        <hr>
        ...
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="2">
                    <table>
                       <td class="title" align="center">
                            <img src="{{asset('/asset/logo.png')}}" style="max-width:300px;">
                        </td>
                        <tr align="center">
                            Booking No : {{$Email->booking_id}}<br>
                            {{$Email->created_at->formatLocalized('%A %d %B %Y')}}<br>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <table>
                        ...
                        <tr> 
                            <td align="left">
                                ...
                                Contact At: {{$Email->provider?$Email->provider->mobile:''}}<br>  
                                Email     : {{$Email->provider?$Email->provider->email:''}}<br>
                                Car Model     : {{$Email->provider_service?($Email->provider_service->cars?$Email->provider_service->cars->name:''):''}} - {{$Email->provider_service?$Email->provider_service->service_number:''}} <br>
                                Car Color     : {{$Email->provider_service?$Email->provider_service->service_color:''}}<br>
                            </td>
                        </tr>
                        @else
                            <tr class="heading">
                                We will reach out to you with cab details in next 30-60 min.
                            </tr> 
                        @endif
                        <tr class="heading">
            ...
            <tr class="item">
                <td data-link-style="text-decoration:none; color:#ff646a;" data-link-color="Content Link" mc:edit="desctiption" width="150" align="left" valign="top" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#3b3b3b; line-height:26px;  font-weight: bold;">Trip Open Time</td>
                 <td data-link-style="text-decoration:none; color:#ff646a;" data-link-color="Content Link" mc:edit="value-3" width="300" align="left" valign="top" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#3b3b3b; line-height:26px;  font-weight: bold;">{{$Email->user_started_at->formatLocalized('%A %d %B %Y')}}</td>
            </tr>
            ...
            <tr class="item">
                <td data-link-style="text-decoration:none; color:#ff646a;" data-link-color="Content Link" mc:edit="desctiption" width="263" align="left" valign="top" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#3b3b3b; line-height:26px;  font-weight: bold;">Approximate Fare</td>
                 <td data-link-style="text-decoration:none; color:#ff646a;" data-link-color="Content Link" mc:edit="value-3" width="87" align="left" valign="top" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#3b3b3b; line-height:26px;  font-weight: bold;">{{Setting::get('currency','INR')}}{{$Email->estimated_fare}}</td>
