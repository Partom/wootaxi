...
<div class="col-md-9">
    <div class="dash-content">
		...
		<div class="row no-margin">
		        ...
		        <div class="col-md-12">
	                <h2 class="text-center">Chat with Driver</h2>
	                <div class="row">
	                    <div class="panel-chat well m-n" id="chat-box" style="overflow-y: scroll; height: 100px;">
	                    </div>
	                    <div class="p-md">
				...
				<div>
		            ...
		            <br/>
		            	...
		            	<dl className="dl-horizontal left-right">
                        	...
                        	<dd>{this.props.checkState.distance} @lang('user.ride.km')</dd>
                        </dl>
