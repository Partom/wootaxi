    ...
    <div class="full-page-bg-inner">
        <div class="row no-margin">
            <div class="col-md-6 log-left">
                ...
                <p>Welcome to {{Setting::get('site_title', 'WooCabs')}}, the easiest way to get around at the tap of a button.</p>
            </div>
            <div class="col-md-6 log-right">
                ...
                <div class="log-copy"><p class="no-margin">{{ Setting::get('site_copyright', '&copy; '.date('Y').' Hepto') }}</p></div></div>
            </div>
        </div>
    </div>
</div>
