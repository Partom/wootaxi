...
Route::post('/insurance/document' , 'ProviderAuth\TokenController@insurance_document');
Route::post('/license/document' , 'ProviderAuth\TokenController@license_document');
Route::post('/vehicle/document' , 'ProviderAuth\TokenController@vehicle_document');
...
Route::get('/terms', 'ProviderAuth\TokenController@terms');
Route::get('/service', 'ProviderAuth\TokenController@services');
Route::get('/brand/{service}', 'ProviderAuth\TokenController@brands');
