...
Route::get('notify', 'Resource\UserResource@push')->name('user.push');
Route::post('push/notify', 'Resource\UserResource@send_push')->name('user.notify');
...
Route::group(['as' => 'service.'], function () {
    Route::resource('service/{service}/brand', 'Resource\ServiceCarBrandResource');
});
