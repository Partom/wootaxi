...
//Route::get('auth/facebook', 'Auth\SociWooginController@redirectToFaceBook');
//Route::get('auth/facebook/callback', 'Auth\SociWooginController@handleFacebookCallback');
//Route::get('auth/google', 'Auth\SociWooginController@redirectToGoogle');
//Route::get('auth/google/callback', 'Auth\SociWooginController@handleGoogleCallback');
...
Route::group(['prefix' => 'provider'], function () {
    ...
    Route::get('auth/facebook', 'Auth\SociWooginController@providerToFaceBook');
    Route::get('auth/google', 'Auth\SociWooginController@providerToGoogle');
