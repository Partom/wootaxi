        ...
        return (
            <div className="row no-margin">
                <div className="col-md-6">
                    ...
                    {this.props.button}
                    {((this.props.request.status == "ACCEPTED" || this.props.request.status == "ARRIVED") || this.props.request.status == "STARTED" )?
                    <div className="panel panel-default" id="chat-place">
                        <div className="panel-body">
                            <h2 className="text-center">Chat with {this.props.request.user.first_name} {this.props.request.user.last_name}</h2>
                            <div className="row">
                                <div className="panel-chat well m-n chatwindowscroll" id="chat-box">
                                </div>
                            </div>
                            <div className="p-md panel-footer">
                                <div className="input-group">
                                    <input placeholder="Enter your message here" className="form-control" type="text" id="chat-input" />
                                    <span className="input-group-btn">
                                        <button type="button" id="chat-send" className="btn btn-default"><i className="fa fa-arrow-right"></i></button>
                                    </span>
                                </div>
                            </div>
                        </div>
...
class TripComponent extends React.Component {
    ...
    componentDidUpdate() {
        updateChatParam(this.props.request.id, this.props.request.user.id); 
