...
class UserApiController extends Controller
{
    ...
    public function send_request(Request $request) {
        ...
        try{
            ...
            if($User){
                $TextMsg = "Dear ".$User->first_name." ".$User->first_name.", Thanks for Booking, We are Ready to Provide the Taxi Service. Your Booking ID : ".$UserRequest->booking_id.". Contact At : ".env('CONTACT_AT');
