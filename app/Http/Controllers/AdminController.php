...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        try{
            ...
            $provider_approval = Provider::whereIn('status',['onboarding','banned'])->count();
            ...
            return view('admin.dashboard',compact('providers','service','provider_approval','rides','user_cancelled','provider_cancelled','cancel_rides','revenue'));
        }
        catch(Exception $e){
    ...
    {
        try {
            $str = file_get_contents('http://hepto.com/help.json');
