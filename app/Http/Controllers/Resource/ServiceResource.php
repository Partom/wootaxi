...
class ServiceResource extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'outer_fixed' => 'required|numeric',
            'outer_price' => 'required|numeric',
            'outer_distance' => 'required|numeric',
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $service->distance = $request->distance;
             $service->outer_fixed = $request->outer_fixed;
            $service->outer_price= $request->outer_price;
            $service->outer_distance = $request->outer_distance;
            $service->connection = $request->connection;
            $service->day = $request->day;
            $service->ride = $request->ride;
